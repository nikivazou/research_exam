...
a list of distinct elements, i.e., not containing any duplicates.
...
\end{code}\end{tabular}$$
%
Thus, abstract refinements allow us to decouple the definition 
